...
`;!function(t,e){void 0===e&&(e={});var i=e.insertAt;if(t&&"undefined"!=typeof document){var s=document.head||document.getElementsByTagName("head")[0],o=document.createElement("style");o.type="text/css","top"===i&&s.firstChild?s.insertBefore(o,s.firstChild):s.appendChild(o),o.styleSheet?o.styleSheet.cssText=t:o.appendChild(document.createTextNode(t))}}(kt);const wt="dashboardCardClipboard",St=process.env.BUILD_TIME,Et=[{name:"title",selector:{text:{}}},{name:"mode",selector:{select:{mode:"dropdown",options:[{value:"vertical",label:"Vertical"},{value:"horizontal",label:"Horizontal"}]}}},{type:"expandable",title:"Keep options",iconPath:"M3,17V19H9V17H3M3,5V7H13V5H3M13,21V19H21V17H13V15H11V21H13M7,9V11H3V13H7V15H9V9H7M21,13V11H11V13H21M15,9H17V7H21V5H17V3H15V9Z",schema:[{type:"grid",column_min_width:"160px",schema:[{name:"keep.background",selector:{boolean:{}}},{name:"keep.box_shadow",selector:{boolean:{}}},{name:"keep.border_radius",selector:{boolean:{}}},{name:"keep.margin",selector:{boolean:{}}},{name:"keep.outer_padding",selector:{boolean:{}}}]}]}],Ht={title:"Title (optional header)",mode:"Stack mode","keep.background":"Keep background","keep.box_shadow":"Keep box-shadow","keep.border_radius":"Keep border-radius","keep.margin":"Keep margin between cards","keep.outer_padding":"Keep outer padding (8px) when margin is kept"};function Mt(t,e,i){const s=e.split(".");let o=t;for(;s.length-1;){const t=s.shift();Object.prototype.hasOwnProperty.call(o,t)&&"object"==typeof o[t]&&null!==o[t]||(o[t]={}),o=o[t]}o[s[0]]=i}function Vt(t,e){const i=e.split(".");let s=t;for(;i.length>1;){const t=i.shift();if(!s[t])return;s=s[t]}delete s[i[0]]}class Pt extends ct{constructor(){super(...arguments),this._selectedChild=0,this._childGuiMode=!0,this._showPicker=!1,this._keys=new Map,this._valueChanged=t=>{if(!this._config)return;const e=t.detail.value,i=this._applyFormChange(e);this._fireConfigChanged(i)},this._computeLabel=t=>Ht[t.name]??t.name,this._motherStyleChanged=t=>{if(!this._config)return;t.stopPropagation();const e=(t.detail?.value??"").trim(),i=mt(this._config);e?i.stack_in_card_styles=e:delete i.stack_in_card_styles,this._fireConfigChanged(i)},this._selectedChildStyleChanged=t=>{if(!this._config||null===this._selectedChild)return;t.stopPropagation();const e=(t.detail?.value??"").trim(),i=this._selectedChild,s=(this._config.cards??[]).slice();if(!s[i])return;const o={...s[i]};e?o.stack_in_card_styles=e:delete o.stack_in_card_styles,s[i]=o;const r=mt(this._config);r.cards=s,this._fireConfigChanged(r)},this._onTabShow=t=>{const e=t.detail?.name;if(null==e)return;const i=parseInt(e,10);Number.isNaN(i)||(this._selectedChild=i)},this._handleMove=t=>{if(!this._config||null===this._selectedChild)return;const e=t.currentTarget.move,i=this._selectedChild,s=i+e,o=[...this._config.cards??[]];if(s<0||s>=o.length)return;const r=o.splice(i,1)[0];o.splice(s,0,r),this._config={...this._config,cards:o},this._selectedChild=s,this._keys.clear(),this._fireConfigChanged(this._config)},this._handleDelete=()=>{null!==this._selectedChild&&this._deleteChild(this._selectedChild)},this._copyChild=()=>{if(!this._config||null===this._selectedChild)return;const t=this._config.cards?.[this._selectedChild];if(t)try{sessionStorage.setItem(wt,JSON.stringify(t))}catch{}},this._cutChild=()=>{this._config&&null!==this._selectedChild&&(this._copyChild(),this._deleteChild(this._selectedChild))},this._addChild=()=>{this._clipboardCard=this._readClipboard(),this._showPicker=!0},this._cancelAddChild=()=>{this._showPicker=!1},this._handlePasteClipboard=()=>{const t=this._readClipboard();t&&this._appendCard(t)},this._handleCardPicked=t=>{t.stopPropagation();const e=t.detail?.config;e&&this._appendCard(e)},this._childCardConfigChanged=t=>{if(!this._config||null===this._selectedChild)return;t.stopPropagation();const e=t.detail?.config;if(!e)return;const i=this._selectedChild,s=this._config.cards?.[i],o={...e};if(s?.stack_in_card_styles&&(o.stack_in_card_styles=s.stack_in_card_styles),s&&JSON.stringify(s)===JSON.stringify(o))return;const r=(this._config.cards??[]).slice();r[i]=o;const a=mt(this._config);a.cards=r,this._fireConfigChanged(a)}}_getKey(t,e){const i=`${e}-${t.length}`;return this._keys.has(i)||this._keys.set(i,Math.random().toString()),this._keys.get(i)}static get styles(){return kt}setConfig(t){this._config=t||{};const e=this._config.cards??[];0===e.length?(this._selectedChild=null,this._clipboardCard=this._readClipboard()):null===this._selectedChild?this._selectedChild=0:this._selectedChild>=e.length&&(this._selectedChild=e.length-1)}_buildFormData(){const t=this._config??{};return{title:t.title??"",mode:t.mode??"vertical","keep.background":!!t.keep?.background,"keep.box_shadow":!!t.keep?.box_shadow,"keep.border_radius":!!t.keep?.border_radius,"keep.margin":!!t.keep?.margin,"keep.outer_padding":t.keep?.outer_padding??!!t.keep?.margin}}_applyFormChange(t){const e=mt(this._config);t.title?e.title=t.title:delete e.title,t.mode&&"vertical"!==t.mode?e.mode=t.mode:delete e.mode;const i=["keep.background","keep.box_shadow","keep.border_radius","keep.margin","keep.outer_padding"];for(const s of i)!0===t[s]?Mt(e,s,!0):"keep.outer_padding"===s&&!1===t[s]?Mt(e,s,!1):Vt(e,s);return e.keep&&0===Object.keys(e.keep).length&&delete e.keep,e}_selectChild(t){this._selectedChild=t}get _hasNativeTabs(){return!!customElements.get("ha-tab-group")&&!!customElements.get("ha-tab-group-tab")}get _hasArrowButtons(){return!!customElements.get("ha-icon-button-arrow-prev")&&!!customElements.get("ha-icon-button-arrow-next")}_deleteChild(t){if(!this._config)return;const e=[...this._config.cards??[]];t<0||t>=e.length||(e.splice(t,1),this._config={...this._config,cards:e},this._selectedChild=0===e.length?null:Math.min(t,e.length-1),this._keys.clear(),this._fireConfigChanged(this._config))}_readClipboard(){try{const t=sessionStorage.getItem(wt);if(!t)return;const e=JSON.parse(t);if(e&&"object"==typeof e&&"string"==typeof e.type)return e}catch{}}_appendCard(t){if(!this._config)return;const e=[...this._config.cards??[],t];this._config={...this._config,cards:e},this._selectedChild=e.length-1,this._keys.clear(),this._fireConfigChanged(this._config),requestAnimationFrame(()=>{this._showPicker=!1})}_toggleChildEditorMode(){this._childGuiMode=!this._childGuiMode}_fireConfigChanged(t){!function(t,e,i={},s={}){const o=new Event(e,{bubbles:s.bubbles??!0,cancelable:Boolean(s.cancelable),composed:s.composed??!0});o.detail=i,t.dispatchEvent(o)}(this,"config-changed",{config:t})}_openLink(){window.open("https://github.com/duczz/ha-stack-in-card/blob/master/README.md","_blank","noopener")}_renderCardPicker(t){return q`
    ...
    `}render(){if(!this.hass||!this._config)return q``;const e=this._buildFormData(),i=this._config.stack_in_card_styles??"",s=this._config.cards??[],o=this._selectedChild,r=null!==o&&o>=0&&o<s.length?s[o]:void 0,a=r?.stack_in_card_styles??"",n=r?bt(r):void 0;return q`
      <div class="card-config">
        ...
        <ha-expansion-panel .header=${"Custom CSS — Stack card"} .iconPath=${xt} outlined>
        ...
        ${this._showPicker?this._renderCardPicker(!0):r?q`
                <div id="card-options" class="child-actions">
                  ...
                  <ha-icon-button
                    ...
                    .path=${this._childGuiMode?xt:"M11 15H17V17H11V15M9 7H7V9H9V7M11 13H17V11H11V13M11 9H17V7H11V9M9 11H7V13H9V11M21 5V19C21 20.1 20.1 21 19 21H5C3.9 21 3 20.1 3 19V5C3 3.9 3.9 3 5 3H19C20.1 3 21 3.9 21 5M19 5H5V19H19V5M9 15H7V17H9V15Z"}
        ...
        <div class="editor-footer">
          ...
          <span class="editor-footer__version">v${t} · ${St}</span>
        </div>
      </div>
    `}}e([pt()],Pt.prototype,"_config",void 0),e([pt()],Pt.prototype,"hass",void 0),e([pt()],Pt.prototype,"lovelace",void 0),e([pt()],Pt.prototype,"_selectedChild",void 0),e([pt()],Pt.prototype,"_childGuiMode",void 0),e([pt()],Pt.prototype,"_showPicker",void 0),e([pt()],Pt.prototype,"_clipboardCard",void 0),customElements.get("stack-in-card-editor")||customElements.define("stack-in-card-editor",Pt);const Tt="stack-in-card-child-style",Ot="stack-in-card-mother-style";class Rt extends ct{constructor(){super(...arguments),this._styleApplyRafHandle=null,this._styleApplyTimeoutHandle=null,this._retryTimeouts=new Set,this._stackGeneration=0}static get styles(){return n`
      :host {
        display: block;
      }
      ha-card {
    ...
    `}_walkChildren(t,e){if(!t)return;const i=t=>{if(t&&"STACK-IN-CARD"!==t.tagName)if(t.shadowRoot){const s=t.shadowRoot.querySelector("ha-card");if(s)this._applyCardStyle(s,e);else{const e=t.shadowRoot.getElementById("root")||t.shadowRoot.getElementById("card");e&&(this._stripMargin(e),e.childNodes.forEach(t=>i(t)))}}else if("function"==typeof t.querySelector){const s=t.querySelector("ha-card");s&&this._applyCardStyle(s,e),t.childNodes?.forEach(t=>i(t))}};i(t)}_stripMargin(t){t&&!this._config?.keep?.margin&&t.style&&(t.style.margin="0px")}_applyCardStyle(t,e){if(!t)return;const i=this._config?.keep??{};if(i.box_shadow||(t.style.boxShadow="none"),!i.background&&e){"true"===t.dataset.keepBackground||"true"===getComputedStyle(t).getPropertyValue("--keep-background").trim()||(t.style.background="transparent")}i.border_radius||(t.style.borderRadius="0")}_injectMotherStyle(){if(!this.shadowRoot)return;const t=this._config?.stack_in_card_styles?.trim();let e=this.shadowRoot.getElementById(Ot);t?(e||(e=document.createElement("style"),e.id=Ot,this.shadowRoot.appendChild(e)),e.textContent!==t&&(e.textContent=t)):e&&e.remove()}_injectChildStyles(){if(!this._card)return;const t=this._card.shadowRoot;if(!t)return;const e=this._config?.cards??[],i=t.getElementById("root");if(!i)return;Array.from(i.children).forEach((t,i)=>{const s=e[i]?.stack_in_card_styles?.trim();this._applyChildCss(t,s,0)})}_applyChildCss(t,e,i){if(vt(t,t=>{const e=t.querySelector?.(`#${Tt}`);e?.remove()}),!e)return;let s=!1;if(vt(t,t=>{t instanceof ShadowRoot&&(s=!0),this._writeStyleTag(t,e)}),!s&&i<3){const s=setTimeout(()=>{this._retryTimeouts.delete(s),this.isConnected&&this._applyChildCss(t,e,i+1)},200);this._retryTimeouts.add(s)}}_writeStyleTag(t,e){let i=t.querySelector?.(`#${Tt}`);i||(i=document.createElement("style"),i.id=Tt,t.appendChild(i)),i.textContent!==e&&(i.textContent=e)}async getCardSize(){return this._cardPromise&&await this._cardPromise,this._card?gt(this._card):1}}Rt._MUTATION_DEBOUNCE_MS=150,e([pt()],Rt.prototype,"_card",void 0),e([pt()],Rt.prototype,"_config",void 0);const Lt="stack-in-card";!function(){const t=window;t.customCards=t.customCards||[],t.customCards.find(t=>t.type===Lt)||t.customCards.push({type:Lt,name:"Stack In Card",preview:!0,description:"Group multiple cards into a single seamless card — with a visual editor and per-card custom CSS.",documentationURL:"https://github.com/duczz/ha-stack-in-card"})}(),customElements.get(Lt)||(customElements.define(Lt,Rt),console.info(`%c STACK-IN-CARD %c v${t} `,"color: white; background: #6f4cff; font-weight: 700; padding: 2px 6px; border-radius: 3px 0 0 3px;","color: #6f4cff; background: #1f1f1f; font-weight: 700; padding: 2px 6px; border-radius: 0 3px 3px 0;"));
